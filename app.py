...
def load_model():
    try: 
        model = pickle.load(open("/content/drive/MyDrive/Proyecto_Curso_IA/Copia_de_la_copia_de_ProyectoAi.pkl", "rb"))
        return model
...
#st.selectedbox("Seleccione una pregunta", options=["¿Me puedes ayudar a elegir una carrera?", ], key="user_input", on_change=send_msg)
